...
<body>
    ...
    <header class="header" role="banner">
        ...
        <h1 class="logo">
            <a href="sidebar.php">หน้าหลัก <span>แอดมิน</span></a>
        </h1>
        <div class="nav-wrap">
            <nav class="main-nav" role="navigation">
                <ul class="unstyled list-hover-slide">
                    <li><a href="add_user.php">เพิ่มข้อมูลผู้ใช้</a></li>
                    <li><a href="add_driver.php">เพิ่มข้อมูลคนขับรถ</a></li>
                    <li><a href="add_car.php">เพิ่มข้อมูลรถ</a></li>
                    <li><a href="check_status.php">ตรวจสถานะคำร้อง</a></li>
                ...
                <div class="box">
                    <div class="float" style="margin-left:300px;">
                        ...
                        <form class="form" action="">
                            <!-- ใส่โค้ดตรงนี้ -->
                            <div><br><br>
                                <h2 style="text-align:center; color:ghostwhite">เพิ่มข้อมูลคนขับรถ</h2><br>
                                <form>
                                    <!-- Multiple inputs -->
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="first_name" placeholder="ชื่อจริง">
                                ...
                                <form>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="user_id" placeholder="ชื่อผู้ใช้">
