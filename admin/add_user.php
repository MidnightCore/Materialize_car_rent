                ...
                <div class="box">
                    <div class="float" style="margin-left:300px;">
                        ...
                        <form class="forms-regis" action="add_user2.php" method="post"> 
                            ...
                            <!-- ใส่โค้ดตรงนี้ -->
                            <div><br><br><h2 style="text-align:center; color:ghostwhite">เพิ่มข้อมูลผู้ใช้</h2><br>
                                               
                                <form action="/action_page.php"> <!-- Multiple inputs -->                                  
                                ...
                                <div class="input-group mb-3"><!-- email inputs --> 
                            ...
                            <div style="text-align: center;"><!--ปุ่มกดเพิ่ม-->
